...
<tr><td> Enter a new name <input list = "names" type="text" name="name" required="required" />
<datalist id="names" >
...
<tr><td> Enter a new family <input list = "families" type="text" name="family" required="required"/></td></tr> 
...
<tr><td> Enter a new type <input list= "type" type="text" name="type" required="required" />
  <datalist id="type" >
